...
foreach(@range){
    ...
    $output .= "JOBNAME: qwerrors\n";
    $output .= "OS: Linux64\n";
    $output .= "MEMORY: 1800 MB\n";
    $output .= "COMMAND:sh $dir\/bmod_errors.bash $_ $analyzer > bmod_errors$_.out\n";
    $output .= "OUTPUT_DATA: bmod_errors$_.out\n";
    $output .= "OUTPUT_TEMPLATE:$dir\/log\/bmod_errors$_.out\n";
